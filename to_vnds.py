...
def read_script(script_file:str, collect_jumps:int):
    ...
    while True:
        ...
        if op == 0x02: # JUMP
            ...
            #print("GAME_END")
            vnds.write("text !\n")
            vnds.write("text THE END\n")
            vnds.write("text !\n")
            collect_bg("OMAKE_0.BMP")
            collect_bg("OMAKE_1.BMP")
            collect_bg("OMAKE_2.BMP")
            collect_bg("OMAKE_3.BMP")
            collect_bg("OMAKE_4.BMP")
            collect_bg("OMAKE_5.BMP")
            collect_bg("OMAKE_6.BMP")
            collect_bg("OMAKE_7.BMP")
            collect_bg("OMAKE_8.BMP")
            collect_bg("OMAKE_9.BMP")
            collect_bg("OMAKE_9A.BMP")
            vnds.write("bgload OMAKE_0.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_1.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_2.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_3.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_4.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_5.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_6.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_7.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_8.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_9.jpg\n")
            vnds.write("text !\n")
            vnds.write("bgload OMAKE_9A.jpg\n")
            vnds.write("text !\n")
